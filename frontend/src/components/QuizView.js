...
class QuizView extends Component {
  ...
  componentDidMount(){
    $.ajax({
      url: `${configData.API_BASE_URL}/categories`,
      type: "GET",
      success: (result) => {
  ...
  getNextQuestion = () => {
    ...
    $.ajax({      
      url: `${configData.API_BASE_URL}/quizzes`,
      type: "POST",
      dataType: 'json',
  ...
  evaluateAnswer = () => {
    ...
    if(this.state.guess.toLowerCase() == this.state.currentQuestion.answer.toLowerCase()){
      return true;
    }
